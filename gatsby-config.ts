...
const config: GatsbyConfig = {
  siteMetadata: {
    ...
    type: `website`,
    siteUrl: siteUrl,
    keywords: `artist,art,storyboard,animation,portfolio,panels,tv,television,
               commission,freelance,film,beats,illustration`,
    locales: [`en_US`, `ja_JP`],
    openGraphImage: `/images/placeholders/1200x630placeholder.png`,
    twitterImage: `/images/placeholders/1200x600placeholder.png`,
